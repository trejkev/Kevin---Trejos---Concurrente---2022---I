...
The tables containing the data are 1 for serial, 2 for pthreads, and 3 for OpenMP, original dataset can be found in this file: https://github.com/trejkev/Kevin-Trejos-Concurrente-2022-I/blob/main/tareas/tetris_solver_omp/report/Results%20data.ods
