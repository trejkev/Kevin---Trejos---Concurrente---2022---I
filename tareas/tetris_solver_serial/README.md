...
counts the amount of empty rows, and computes the metric as score = max_height - y_position_first_non-empty_cell. This is a non-optimized solution, as requested by the problem statement repository mentioned below.
...
Running the code:
  ...
  6. Check files into /test for the txt files of the best game for each level, named as tetris_play_{level}.txt.
